...
microlang_tests[44] = function()
{
    ...
    success = assert( output['s'] === 'boo', 's = "boo"' );
...
microlang_tests[47] = function()
{
    ...
    success = assert( output['s'] === '))   baz', 's = "))   baz"' );
...
microlang_tests[56] = function()
{
    ...
    success = assert( output['s'] === 'boo' && output['i'] === 1, 's = "boo", i = 1' );
...
microlang_tests[59] = function()
{
    ...
    success = assert( output['s'] === '))   baz' && output['i'] === 1, 's = "))   baz", i = 1' );
