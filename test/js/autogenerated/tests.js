...
microlang_tests[12] = function()
{
    ...
    success = assert( output['ts'] === 'string' && output['ti'] === 'int' && output['tf'] === 'float', 'ts = "string", ti = "int", tf = "float"' );
...
microlang_tests[41] = function()
{
    ...
    success = assert( output['s'] === 'some text', 's = "some text"' );

    return success;
};


microlang_tests[42] = function()
{
    var success;
...
microlang_tests[43] = function()
{
    ...
    success = assert( output['s'] === 'bar', 's = "bar"' );

    return success;
};


microlang_tests[44] = function()
{
    var success;
    ...
    success = assert( output['s'] === 'bar©[[boo', 's = "bar©[[boo"' );

    return success;
};


microlang_tests[45] = function()
{
    var success;
...
microlang_tests[47] = function()
{
    ...
    success = assert( output['s'] === 'bar[[))   baz', 's = "bar[[))   baz"' );

    return success;
};


microlang_tests[48] = function()
{
    var success;
    ...
    success = assert( output['s'] === 'foo   [[bar))   baz', 's = "foo   [[bar))   baz"' );

    return success;
};


microlang_tests[49] = function()
{
    var success;
...
microlang_tests[57] = function()
{
    ...
    success = assert( output['s'] === 'bar' && output['i'] === 1, 's = "bar", i = 1' );

    return success;
};


microlang_tests[58] = function()
{
    var success;
    ...
    success = assert( output['s'] === 'bar[[boo' && output['i'] === 1, 's = "bar[[boo", i = 1' );

    return success;
};


microlang_tests[59] = function()
{
    var success;
...
microlang_tests[60] = function()
{
    ...
    success = assert( output['s'] === 'foo   [[bar' && output['i'] === 1, 's = "foo   [[bar", i = 1' );

    return success;
};


microlang_tests[61] = function()
{
    var success;
    ...
    success = assert( output['s'] === 'bar[[))   baz' && output['i'] === 1, 's = "bar[[))   baz", i = 1' );

    return success;
};


microlang_tests[62] = function()
{
    var success;
    ...
    success = assert( output['s'] === 'foo   [[bar))   baz' && output['i'] === 1, 's = "foo   [[bar))   baz", i = 1' );

    return success;
};


microlang_tests[63] = function()
{
    var success;
    ...
    success = assert( output['s'] === '' && output['i'] === 1, 's = "", i = 1' );

    return success;
};


microlang_tests[64] = function()
{
    var success;
    ...
    success = assert( output['s'] === '' && output['i'] === 0, 's = "", i = 0' );

    return success;
};


microlang_tests[65] = function()
{
    var success;
...
microlang_tests[69] = function()
{
    ...
    success = assert( output['i'] === 4, 'i = 4' );

    return success;
};


microlang_tests[70] = function()
{
    var success;
...
microlang_tests[71] = function()
{
    ...
    success = assert( output['i'] === -1, 'i = -1' );

    return success;
};


microlang_tests[72] = function()
{
    var success;
...
microlang_tests[77] = function()
{
    ...
    success = assert( output['i'] === 9, 'i = 9' );

    return success;
};


microlang_tests[78] = function()
{
    var success;
    ...
    success = assert( output['i'] === 0, 'i = 0' );

    return success;
};


microlang_tests[79] = function()
{
    var success;
...
microlang_tests[81] = function()
{
    ...
    success = assert( output['i'] === 12, 'i = 12' );

    return success;
};


microlang_tests[82] = function()
{
    var success;
    ...
    success = assert( output['s'] === 'Foo © bar 😀 baz ☃ qux', 's = "Foo © bar 😀 baz ☃ qux"' );

    return success;
};


microlang_tests[83] = function()
{
    var success;
    ...
    success = assert( output['l'] === 21, 'l = 21' );
